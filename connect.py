...
import jwt
import datetime
from parseargs import parse_command_line_args
import time
import random
import logging
import ast
from read_card import read_card,signal_auth, signal_notauth
...
def on_message(unused_client, unused_userdata, message):
    ...
    if mesg_dict['Status'] == 'Authorised' and mesg_dict['CardId'] == scanned_cardid:
       signal_auth()
    else:
       signal_notauth()
...
def mqtt_device_demo(args):
    ...
    while True:
        ...
        scanned_cardid = read_card()
        payload = '{"Card":"' + scanned_cardid + '"}'
